...
angular.module('undf.translations', ['ng'])
    .value('translationsLoader', {
        load : function (translats) {
            this.translations = translats;
        },
        get: function () {
    ...
    .factory('uTrans', function(translationsLoader) {

        var translations = translationsLoader.get();
        ...
        translator.trans = function (text, params) {
            ...
            if(params !== undefined && !angular.isObject(params)){
                throw 'uTrans error . The parameters provided for the translation of "' +
                text +
                '" must be an Object and a "' +
                (typeof params )  +
                '" has been provided';
            }
